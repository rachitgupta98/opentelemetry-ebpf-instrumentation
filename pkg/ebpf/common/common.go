...
const (
	EventTypeHTTPRequest        = 1  // EVENT_HTTP_REQUEST - HTTP server request
	EventTypeGRPCRequest        = 2  // EVENT_GRPC_REQUEST - gRPC server request
	EventTypeHTTPClient         = 3  // EVENT_HTTP_CLIENT - HTTP client request
	EventTypeGRPCClient         = 4  // EVENT_GRPC_CLIENT - gRPC client request
	...
	EventTypeGoRuntimeMetric    = 17 // EVENT_GO_RUNTIME_METRICS - Go runtime scalar metrics
