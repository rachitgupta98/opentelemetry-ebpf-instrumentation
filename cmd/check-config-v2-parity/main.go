...
func parityChecks() []parityCheck {
	return []parityCheck{
		...
		{[]string{"ebpf", "log_enricher", "field_names", "trace_id"}, []string{"obi", "correlation", "log_trace_annotation", "field_names", "trace_id"}},
		{[]string{"ebpf", "log_enricher", "field_names", "span_id"}, []string{"obi", "correlation", "log_trace_annotation", "field_names", "span_id"}},
		{[]string{"ebpf", "log_enricher", "plain_text", "enabled"}, []string{"obi", "correlation", "log_trace_annotation", "plain_text", "enabled"}},
		{[]string{"ebpf", "log_enricher", "plain_text", "placement"}, []string{"obi", "correlation", "log_trace_annotation", "plain_text", "placement"}},
		{[]string{"ebpf", "log_enricher", "plain_text", "multiline"}, []string{"obi", "correlation", "log_trace_annotation", "plain_text", "multiline"}},
		...
		{[]string{"routes", "patterns"}, []string{"obi", "capture", "instrumentation", "http", "routes", "incoming", "patterns"}},
		{[]string{"routes", "patterns"}, []string{"obi", "capture", "instrumentation", "http", "routes", "outgoing", "patterns"}},
		{[]string{"routes", "ignored_patterns"}, []string{"obi", "capture", "instrumentation", "http", "routes", "incoming", "ignored_patterns"}},
		{[]string{"routes", "ignored_patterns"}, []string{"obi", "capture", "instrumentation", "http", "routes", "outgoing", "ignored_patterns"}},
		{[]string{"routes", "wildcard_char"}, []string{"obi", "capture", "instrumentation", "http", "routes", "incoming", "wildcard_char"}},
		{[]string{"routes", "wildcard_char"}, []string{"obi", "capture", "instrumentation", "http", "routes", "outgoing", "wildcard_char"}},
		{[]string{"routes", "max_path_segment_cardinality"}, []string{"obi", "capture", "instrumentation", "http", "routes", "incoming", "max_path_segment_cardinality"}},
		{[]string{"routes", "max_path_segment_cardinality"}, []string{"obi", "capture", "instrumentation", "http", "routes", "outgoing", "max_path_segment_cardinality"}},
